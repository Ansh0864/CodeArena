      ...
      <div className="z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="bg-[#1e293b] p-8 rounded-2xl border border-pink-500/20 hover:border-pink-500 transition-all cursor-pointer group">
                ...
                <h3 className="text-xl font-bold mb-2">Javascript Async/Await</h3>
                ...
                <div className="mt-6 flex justify-between items-center">
                    ...
                    <button className="text-pink-400 font-bold text-sm">START &rarr;</button>
                </div>
            </div>
             ...
             <div className="bg-[#1e293b] p-8 rounded-2xl border border-pink-500/20 hover:border-pink-500 transition-all cursor-pointer group">
                ...
                <h3 className="text-xl font-bold mb-2">Python Memory Leak</h3>
