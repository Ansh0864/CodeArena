  ...
  return (
    <div className="pt-32 pb-20 px-6 min-h-screen flex flex-col items-center">
      ...
      <div className="z-10 text-center max-w-3xl mx-auto">
        ...
        <button className="mt-8 bg-emerald-500 hover:bg-emerald-400 text-black font-black py-4 px-12 rounded-xl text-lg shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all transform hover:scale-105">
            START MATCHMAKING
        </button>
      </div>
    </div>
